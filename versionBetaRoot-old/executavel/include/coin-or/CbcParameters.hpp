...
public:
  ...
  */
  ...
  /*! \brief Obtain a prototype for a lift knapsack cover cut generator. */
  CbcParameters::CGMode getLiftKnapsack(CglCutGenerator *&gen);

  /*! \brief Set mode for use of lift knapsack cut generator. */
  inline void setLiftKnapsackMode(CbcParameters::CGMode mode) {
    liftknapsack_.mode_ = mode;
  }
  /*! \brief Get mode for use of knapsack cut generator. */
  inline CbcParameters::CGMode getLiftKnapsackMode() { return (liftknapsack_.mode_); }
...
private:
  ...
  /*! \brief Control variable and prototype for lift knapsack cover cut generator */
  CGSettings<CglLiftKnapsack> liftknapsack_;
